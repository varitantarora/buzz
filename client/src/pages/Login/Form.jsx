...
const Form = () => {
    ...
    const register = async (values, onSubmitProps) => {
        // this allow us send form info with image
    ...
    return (
        ...
        >
            {({ values, errors, touched, handleSubmit, handleBlur, handleChange, setFieldValue, resetForm }) => (
                <form onSubmit={handleSubmit}>
                    ...
                    <Box>
                        ...
                        >
                            {isLogin ? "'Doesn't have account? Sign up here." : 'Already have an account? Login here.'}
                        </Typography>
                    </Box>
                </form>
            )}
